...
{
  return $(window).width()<480?$("#roadmap_scrollable").animate({scrollLeft:"+=270"},700):$("#roadmap_scrollable").animate({scrollLeft:"+=500"},700),!1
}
    ...
    for (var i = 0; i < balls.length; i++) {
        for (var j = i + 1; j < balls.length; j++) {
           ...
           if(fraction < 1){
               ...
               ctx.strokeStyle = 'rgba(255,233,0,'+alpha+')';
